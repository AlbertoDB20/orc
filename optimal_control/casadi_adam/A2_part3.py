...
def create_and_solve_ocp(N, nx, nq, lbx, ubx, dt, x_init,
    ...
    # X are the states, U the controls, S the path variables, W the auxiliary variables for path progression speed
